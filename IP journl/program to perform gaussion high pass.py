...
plt.subplot(222),plt.imshow(H,cmap='gray'),plt.title('Gaussian High Pass mask')
plt.subplot(223),plt.imshow(mag_s,cmap='gray'),plt.title('FFT image')
plt.subplot(224),plt.imshow(img_back,cmap='gray'),plt.title('Gaussian High Pass filtered image')
plt.show()